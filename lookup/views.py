...
def home(request):
    ...
    # api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=text/csv&zipCode=89129&distance=25&API_KEY=B5FD4BAC-0E9B-4BB1-A32B-E027BED4EAB9")
